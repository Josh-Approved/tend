...
const es = {
  ...
  home: {
    ...
    markReachedHint: 'Guarda que contactaste con {name} hoy.',
    lastCheckInLabel: 'Último contacto',
    lastCheckInNever: 'Aún no',
  ...
  person: {
    ...
    birthdayReminderHint: 'Tend te avisa esa misma mañana. Puedes desactivarlo en Ajustes.',
    ...
    remindersSectionLabel: 'Recordatorios y fechas',
    cadenceRow: 'Recordatorio de contacto',
    notSet: 'Sin definir',
    noneYet: 'Nada aún',
    oneSaved: '1 guardado',
  ...
  contactPicker: {
    title: 'Añadir desde contactos',
    guide: 'Elige las personas con las que quieres mantener el contacto. La mayoría empieza con unas pocas. Siempre puedes añadir más después.',
    search: 'Buscar contactos',
    added: 'Añadido',
    addCount: 'Añadir {count}',
    noContacts: 'No se encontraron contactos en este dispositivo.',
    loading: 'Cargando contactos…',
    limitedNote: 'Mostrando los contactos que compartiste.',
  },
};
export default es;
