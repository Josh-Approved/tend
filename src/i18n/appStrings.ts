...
export const APP_STRINGS = {
  ...
  person: {
    ...
    remindersSectionLabel: 'Reminders & milestones',
    cadenceRow: 'Reach-out reminder',
    notSet: 'Not set',
    noneYet: 'None yet',
    oneSaved: '1 saved',
  ...
  contactPicker: {
    ...
    guide: 'Pick the people you want to keep up with. Most start with a few. You can always add more later.',
    search: 'Search contacts',
    added: 'Added',
    addCount: 'Add {count}',
    noContacts: 'No contacts found on this device.',
    loading: 'Loading contacts…',
    limitedNote: 'Showing the contacts you shared.',
  },
} as const;
