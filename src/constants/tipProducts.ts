/**
 * Tip-jar store product ids for Relationships — app-owned (NOT synced from the
...
export const TIP_PRODUCT_IDS = [
  'com.joshapproved.tend.tip.tier1',
  'com.joshapproved.tend.tip.tier2',
  'com.joshapproved.tend.tip.tier3',
  'com.joshapproved.tend.tip.tier4',
  'com.joshapproved.tend.tip.tier5',
] as const;
